...
<html lang="en">
  ...
  <body class="g-sidenav-show  bg-gray-100">
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
      <div class="sidenav-header mb-2 d-flex align-items-center">
      ...
      <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            @if( Str::startsWith(url()->current(), url("teacher/students")) )
            active        
            @endif
            " href="{{ route("students") }}">
          ...
          <li class="nav-item">
            ...
            @if(   Str::startsWith(url()->current(), url("teacher/my-courses"))  )
            active        
            @endif
          ...
          <li class="nav-item">
            <a class="nav-link    
            @if(  url()->current() == url("teacher/profile") )
              active        
              @endif
  ...
  <x-Ui-configurator/>
    ...
    <script defer src="{{ asset("admin/js/soft-ui-dashboard.min2c70.js?v=1.0.3") }}"></script>
