...
<html lang="en">
  ...
  <head>
      ...
      <link href="{{ asset("css/shortcat.css") }}" rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class=" px-3 my-2 logo" href="{{ route("teacher") }}" >
        <img width="75" height="75" src="{{ asset("images/logo/log.jpg") }}" class=" ">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link 
          @if(  url()->current() == url("Dachbord/users"))
          active        
          @endif
          " href="{{ route("users") }}">
          <div class="icon-xxs-custom">
            <x-icon.user-icon/>
        ...
        <li class="nav-item">
          <a class="nav-link 
          @if(  url()->current() == url("Dachbord/teacher"))
          active        
          @endif  " href="{{ route("admin-teacher") }}">
            <div class="icon-xxs-custom">
        ...
        <li class="nav-item">
          <a class="nav-link @if(  url()->current() == url("Dachbord/Courses"))
            active        
            @endif  " href="{{ route("show-corses") }}">
            <div class="icon-xxs-custom">
        ...
        <li class="nav-item">
          <a class="nav-link @if(  url()->current() == url("Dachbord/main-test"))
            active        
            @endif  " href="{{ route("main-test") }}">
            <div class="icon-xxs-custom">
            ...
            <span class="nav-link-text ms-1">Main Test</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link @if(  url()->current() == url("Dachbord/Profile"))
            active        
            @endif  " href="{{ route("profile") }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
