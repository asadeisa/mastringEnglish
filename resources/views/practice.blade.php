  ...
  <div class=" card  w-100 practice-page"> 
     <div class="card-body ">
      <div  class="practice-page-holder  d-flex gap-7 w-100 mt-5">
        ...
        <div id="new-phreases" class="my-4 trans-down"> <a href="{{ route("new-phrases") }}" class="btn btn-info scal-1-1">start</a> </div>
      </div>
        <div  class="practice-wtih-question p-2"><div class="h4 my-3">practice with question </div> 
          ...
          <div  id="question-practice" class=" trans-down "> <a href="{{ route("local-question") }}" class="btn btn-info scal-1-1">start</a> </div>
        </div>
      </div>
